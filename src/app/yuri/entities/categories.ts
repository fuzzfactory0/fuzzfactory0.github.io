...
export const STOCKHOLM =    { id: 4, name: "Stockholm Syndrome", description: 'Love that blooms from hate, blackmail, debt, animosity, rivalry or other kinds of unorthodox situations.' };
...
export const TOXIC =        { id: 14, name: "Toxic As Fuck Yuri", description: 'Abusive relationships, physical violence, manipulation, crime, cheating, if you want to punch the MC, then it falls in this category.' };
export const DRAMA =        { id: 15, name: "Drama Yuri", description: 'Self explanatory' };
export const OTHER =        { id: 16, name: "Regular yuri that doesn't fit anywhere else", description: 'Some series just don\'t have a particular gimmick or topic but are good reads anyway. This category is for those.' };
...
export const ONESHOT =      { id: 18, name: "Yuri OneShots", description: 'One-shots are everything serializations usually can\'t afford to be: experimental, innovative, daring, not necessarily best sellers but some amazing and unique stories are found here.' };
...
export const SCHOOL =       { id: 21, name: "School Life Yuri", description: 'Any yuri between students where the story takes place mostly within a school.' };
...
export const PSYCHO =       { id: 31, name: "Psychological Yuri", description: 'Any in-universe mindfuckery goes in here.' };
export const HORROR =       { id: 32, name: "Horror Yuri", description: 'Rare, but always good.' };
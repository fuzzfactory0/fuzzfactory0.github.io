...
export const DATING =       { id: 22, name: "Already Dating Yuri", description: 'Series where either the girls are already dating at the beginning of the story, or start dating in the very first chapter. The focus is on the relationship itself, not on the path to becoming lovers.' };
...
export const ANTHOLOGY =    { id: 27, name: "Yuri Anthologies", description: 'Anthologies are collections of one-shots. They come in two flavors: anthologies that collect short stories by the same author, and anthologies with a set topic and multiple authors participating. Note: Anthologies are tagged based on their contents, so an anthology with the "Drama" and "Fantasy" tags could mean one of the chapters is a drama, and a different one is fantasy.' };
